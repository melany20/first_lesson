...
Чтобы создать репозиторий, в окне терминала:
1. Создать на компьютере папку **git_exercise**.
`$ mkdir Desktop/git_exercise/`
1. Перейти в папку **git_exercise**.
`$ cd Desktop/git_exercise/`
1. Объявить эту папку репозиторием.
`$ git init`
...
```
Это значит, что репозиторий был создан, но пока пуст. Начните его наполнять: создайте текстовый файл **hello.txt** в папке **git_exercise**:
```
touch hello.txt
```
